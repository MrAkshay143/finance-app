      ...
      <div className="w-full">
        ...
        <div className="relative flex items-center">
          <select
            ...
            className={`w-full bg-white border text-sm text-textDefault rounded-xl px-3.5 py-2.5 pr-10 appearance-none transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 focus:border-brand-primary disabled:bg-gray-50 disabled:text-textMuted ${
          ...
          <div className="absolute right-3.5 pointer-events-none text-textMuted flex items-center" aria-hidden="true">
